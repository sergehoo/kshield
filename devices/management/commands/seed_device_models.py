...
_SEED = [
    ...
    # ─── Terminaux reconnaissance faciale ───
    {
        "brand": "ZKTeco",
        "model": "SpeedFace-V4L",
        "type": "face_terminal",
        "spec": {
            "category": "face_terminal_dynamic",
            "protocol": "ZKAccess SDK + BioSample push",
            "sdk_port": 4370,
            "adapter": "zkteco_speedface",
            "face_capacity": 6000,
            "rfid_capacity": 10000,
            "fingerprint_capacity": 6000,
            "log_capacity": 500000,
            "reco_engine": "ZKFace 7.x embarqué",
            "verification_speed_ms": 500,
            "screen": "IPS 4.3\"",
            "camera": "2MP WDR",
            "ir_led": True,
            "mask_detection": True,
            ...
            "poe": True,
            "use_case": "Terminal biométrique face + carte + PIN — accès dynamique "
                          "en mouvement (jusqu'à 3 m).",
        },
        "is_active": True,
    },
    {
        ...
        "spec": {
            ...
            "adapter": "zkteco_speedface",
            "face_capacity": 3000,
            "reco_engine": "ZKFinger 10.0 + ZKFace 7.x",
            "camera": "2MP WDR",
            "use_case": "Version compacte SpeedFace pour bureau / entrée petite structure.",
        },
        "is_active": True,
    },
    {
        ...
        "spec": {
            "category": "face_terminal_dynamic",
            "protocol": "ISAPI HTTP + HTTP push events",
            "http_port": 80,
            "https_port": 443,
            "isapi_endpoint": "/ISAPI",
            "adapter": "hikvision_isapi",
            "face_capacity": 6000,
            "card_capacity": 50000,
            "fingerprint_capacity": 5000,
            "log_capacity": 1000000,
            "screen": "7\" IPS tactile",
            "camera": "2MP + IR",
            "mask_detection": True,
            "temperature_measurement": False,
            "use_case": "Terminal MinMoe — face + carte + empreinte + QR.",
        },
        "is_active": True,
    },
    {
        ...
        "spec": {
            "category": "face_terminal_dynamic",
            "protocol": "NetSDK ou HTTP API + Onvif Push",
            "http_port": 80,
            "adapter": "dahua_netsdk",
            "face_capacity": 3000,
            "card_capacity": 30000,
            "log_capacity": 300000,
            "screen": "7\" IPS",
            "camera": "2MP + IR",
            "use_case": "Terminal reconnaissance face Dahua.",
        },
        "is_active": True,
    },
    {
        ...
        "spec": {
            "category": "face_terminal_dynamic",
            "protocol": "Anviz CrossChex SDK / TCP",
            "adapter": "anviz_crosschex",
            "face_capacity": 2000,
            "card_capacity": 20000,
            "use_case": "Terminal Anviz — souvent utilisé en Afrique de l'Ouest.",
        },
        "is_active": True,
    },
